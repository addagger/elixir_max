    ...
    quote(location: :keep) do
      defmodule Router do
        ...
        post unquote(opts[:webhook_path]) do
          ...
          Logger.debug("MAX update: #{inspect(update)}", bot: unquote(bot_module))

          MAX.Session.handle_update(unquote(bot_module), update, unquote(opts[:session_timeout]))
